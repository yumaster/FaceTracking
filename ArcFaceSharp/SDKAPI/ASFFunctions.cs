...
namespace ArcFaceSharp.SDKAPI
{
    ...
    public class ASFFunctions
    {
        ...
        [DllImport(Dll_PATH, CallingConvention = CallingConvention.Cdecl)]
        public static extern int ASFProcess(IntPtr pEngine, int width, int height, int format, IntPtr imgData, ref ASF_MultiFaceInfo multiFaceInfo, uint combinedMask);
        ...
        [DllImport(Dll_PATH, CallingConvention = CallingConvention.Cdecl)]
        public static extern int ASFGetAge(IntPtr pEngine, ref ASF_AgeInfo ageInfo);
